...
if(isset($_POST['submit'])){
    ...
    $select_users=mysqli_query($conn,"SELECT * FROM `adminregister` WHERE email='$email' AND password='$password'") or die(mysqli_error($conn));
    ...
    if(mysqli_num_rows($select_users) > 0){
        ...
        if($row['user_id'] =='admin'){
            ...
            echo "<script type = 'text/javascript'>alert('You have been successfully logged in as Admin!');</script>";
     ...
     <div class="wrapper">
        <form action="login.php" method="post">
              ...
              <div class="register-link">
                <p>Register Here</p><a href="adminregister.php">Sign up</a>
              </div>
        </form>
     </div>
